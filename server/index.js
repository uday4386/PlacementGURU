    ...
    for (const s of uniqueRows) {
      await query(`
        ...
        ON CONFLICT (roll_number) DO UPDATE SET
          ...
          alternate_mail_id = EXCLUDED.alternate_mail_id,
